...
class ObjetperdueType extends AbstractType
{
    /**
     * {@inheritdoc}
     */
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        'widget' => 'single_text',))->add('gouvernorat', 'Symfony\Component\Form\Extension\Core\Type\ChoiceType', array(
            ...
            ))->add('cond')->add('recompenseOptionnelle')->add('images',\AppBundle\Form\MediaType::class, array('required' => false))->add('image2',\AppBundle\Form\MediaType::class, array('required' => false))->add('image3',\AppBundle\Form\MediaType::class, array('required' => false));
    }/**
 * {@inheritdoc}
 */
