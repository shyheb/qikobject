...
class ObjetType extends AbstractType
{
    ...
    {
        $builder->add('type')->add('description')->add('date',DateType::class, array(
            // renders it as a single text boxz
        ...
        ))->add('cond')->add('recompenseOptionnelle')->add('images',\AppBundle\Form\MediaType::class,array('required' => false));
    }/**
     * {@inheritdoc}
     */
