...
class  ObjettrouvereditType extends AbstractType
{
    /**
     * {@inheritdoc}
     */
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        ))->add('cond')->add('images',\AppBundle\Form\MediaType::class,array('required' => false))->add('image2',\AppBundle\Form\MediaType::class,array('required' => false))->add('image3',\AppBundle\Form\MediaType::class,array('required' => false));
    }/**
 * {@inheritdoc}
 */
